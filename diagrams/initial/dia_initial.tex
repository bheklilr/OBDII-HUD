...
\tikzstyle{mybox}=[rectangle, rectangle split, rectangle split parts=2, draw=black, rounded corners, fill=blue!40, drop shadow, text centered, text=black, text width=5cm, anchor=north]
